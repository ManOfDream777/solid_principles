...
""" Принцип заключается в том, что высокоуровневые модули, не должны зависеть от низкоуровневых модулей.
    Низкоуровневый модуль - абстракция, высокоуровневый модуль - конкретная реализация. То есть, использование этого принципа, позволяет расширять или изменять функционал низкоуровневых модулей, без изменения высокоуровневых модулей """